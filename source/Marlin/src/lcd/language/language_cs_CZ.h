...
namespace Language_cs_CZ {
  ...
  LSTR MSG_ABOUT                        	= _UxGT("O tiskarne");
  LSTR heat_MSG                           = _UxGT("Zahrivani trysky..");  
  LSTR heat_waitMSG                       = _UxGT("cekejte prosim...");  
  LSTR Tool_MSG                           = _UxGT("Nastroj");
  LSTR Operate_MSG                        = _UxGT("Obsluha zarizeni");    
  LSTR Home_motor                         = _UxGT("Domovska pozice");
  ...
  #if LCD_WIDTH >= 20
    LSTR MSG_PROGRESS_BAR_TEST            = _UxGT("Test ukaz. průbehu");
  #else
    LSTR MSG_PROGRESS_BAR_TEST            = _UxGT("Test uk. průbehu");
  #endif
  ...
  LSTR MSG_LEVEL_BED_WAITING              = _UxGT("Kliknutim spusťte");
  ...
  LSTR MSG_SET_ORIGIN                     = _UxGT("Nastavit pocatek");
  #if PREHEAT_COUNT
  ...
  LSTR MSG_EDIT_MESH                      = _UxGT("Upravit siť bodů");
  LSTR MSG_EDITING_STOPPED                = _UxGT("Konec úprav site");
  ...
  LSTR MSG_OFFSETS_MENU                   = _UxGT("Ofsety nastrojů");
  ...
  LSTR MSG_UBL_MANUAL_MESH                = _UxGT("Manualni siť bodů");
  LSTR MSG_UBL_BC_INSERT                  = _UxGT("Vlozte kartu, zmerte");
  LSTR MSG_UBL_BC_INSERT2                 = _UxGT("Zmerte");
  LSTR MSG_UBL_BC_REMOVE                  = _UxGT("Odstraňte a zmerte");
  ...
  LSTR MSG_UBL_MESH_EDIT                  = _UxGT("Úprava site bodů");
  LSTR MSG_UBL_EDIT_CUSTOM_MESH           = _UxGT("Upravit vlastni siť");
  LSTR MSG_UBL_FINE_TUNE_MESH             = _UxGT("Doladit siť bodů");
  LSTR MSG_UBL_DONE_EDITING_MESH          = _UxGT("Konec úprav site");
  LSTR MSG_UBL_BUILD_CUSTOM_MESH          = _UxGT("Vlastni siť");
  LSTR MSG_UBL_BUILD_MESH_MENU            = _UxGT("Vytvorit siť");
  #if PREHEAT_COUNT
    LSTR MSG_UBL_BUILD_MESH_M             = _UxGT("Siť bodů $");
    LSTR MSG_UBL_VALIDATE_MESH_M          = _UxGT("Kontrola site $");
  #endif
  LSTR MSG_UBL_BUILD_COLD_MESH            = _UxGT("Studena siť bodů");
  LSTR MSG_UBL_MESH_HEIGHT_ADJUST         = _UxGT("Upravit vysku site");
  LSTR MSG_UBL_MESH_HEIGHT_AMOUNT         = _UxGT("Vyska");
  LSTR MSG_UBL_VALIDATE_MESH_MENU         = _UxGT("Zkontrolovat siť");
  LSTR MSG_UBL_VALIDATE_CUSTOM_MESH       = _UxGT("Kontrola vlast. site");
  LSTR MSG_G26_HEATING_BED                = _UxGT("G26 zahrivani podl.");
  LSTR MSG_G26_HEATING_NOZZLE             = _UxGT("G26 zarivani trysky");
  ...
  LSTR MSG_UBL_CONTINUE_MESH              = _UxGT("Pokracovat v siťi");
  LSTR MSG_UBL_MESH_LEVELING              = _UxGT("Siťove rovnani");
  ...
  LSTR MSG_UBL_OUTPUT_MAP                 = _UxGT("Exportovat siť");
  ...
  LSTR MSG_UBL_STORAGE_SLOT               = _UxGT("Pameťovy slot");
  LSTR MSG_UBL_LOAD_MESH                  = _UxGT("Nacist siť bodů");
  LSTR MSG_UBL_SAVE_MESH                  = _UxGT("Ulozit siť bodů");
  LSTR MSG_MESH_LOADED                    = _UxGT("Siť %i nactena");
  LSTR MSG_MESH_SAVED                     = _UxGT("Siť %i ulozena");
  ...
  LSTR MSG_UBL_1_BUILD_COLD_MESH          = _UxGT("1. Studena siť bodů");
  LSTR MSG_UBL_2_SMART_FILLIN             = _UxGT("2. Chytra hustota");
  LSTR MSG_UBL_3_VALIDATE_MESH_MENU       = _UxGT("3. Zkontrolovat siť");
  LSTR MSG_UBL_4_FINE_TUNE_ALL            = _UxGT("4. Upravit vsechny");
  LSTR MSG_UBL_5_VALIDATE_MESH_MENU       = _UxGT("5. Zkontrolovat siť");
  LSTR MSG_UBL_6_FINE_TUNE_ALL            = _UxGT("6. Upravit vsechny");
  LSTR MSG_UBL_7_SAVE_MESH                = _UxGT("7. Ulozit siť bodů");
  ...
  LSTR MSG_BLTOUCH_MODE_CHANGE            = _UxGT("VAROVANi: spatne nastaveni můze způsobit skody! Pokracovat?");
  LSTR MSG_TOUCHMI_PROBE                  = _UxGT("TouchMI");
  LSTR MSG_TOUCHMI_INIT                   = _UxGT("Inic. TouchMI");
  LSTR MSG_TOUCHMI_ZTEST                  = _UxGT("Test Z Ofsetu");
  LSTR MSG_TOUCHMI_SAVE                   = _UxGT("Uloziy");
  ...
  LSTR MSG_HOME_FIRST                     = _UxGT("Domů %s%s%s prvni");
  ...
  LSTR MSG_THERMAL_RUNAWAY                = _UxGT("TEPLOTNi ÚNIK");
  ...
  LSTR MSG_DELTA_HEIGHT_CALIBRATE         = _UxGT("Nast.vysku delty");
  ...
  LSTR MSG_INFO_RUNAWAY_OFF               = _UxGT("Sledovani úniku: VYP");
  LSTR MSG_INFO_RUNAWAY_ON                = _UxGT("Sledovani úniku: ZAP");
  ...
  #if LCD_WIDTH >= 20
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("Pocet tisků");
  ...
  LSTR MSG_DRIVE_STRENGTH                 = _UxGT("Buzeni motorů");
