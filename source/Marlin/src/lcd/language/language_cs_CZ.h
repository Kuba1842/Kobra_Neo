...
namespace Language_cs_CZ {
  ...
  LSTR MSG_MOVE_E_IN                      = _UxGT("Zavest filament");     
  ...
  LSTR MSG_A_STEPS                        = LCD_STR_A _UxGT(" kroku/mm");
  LSTR MSG_B_STEPS                        = LCD_STR_B _UxGT(" kroku/mm");
  LSTR MSG_C_STEPS                        = LCD_STR_C _UxGT(" kroku/mm");
  LSTR MSG_I_STEPS                        = LCD_STR_I _UxGT(" kroku/mm");
  LSTR MSG_J_STEPS                        = LCD_STR_J _UxGT(" kroku/mm");
  LSTR MSG_K_STEPS                        = LCD_STR_K _UxGT(" kroku/mm");
  LSTR MSG_E_STEPS                        = _UxGT("E kroku/mm");
  LSTR MSG_EN_STEPS                       = _UxGT("* kroku/mm");
  LSTR MSG_TEMPERATURE                    = _UxGT("Teplota");
  LSTR MSG_PREHEAT_PLA				 						= _UxGT("Zahrat pro PLA");     // "Temperature"
	LSTR MSG_PREHEAT_ABS				 						= _UxGT("Zahrat pro ABS");     // "Temperature"
  ...
  LSTR MSG_PRINT_TIME                     = _UxGT("Cas tisku");
}
